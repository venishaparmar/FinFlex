      ...
      <div className='w-full h-[900px] mx-auto px-8 py-8 mb-4 border bg-white shadow-md rounded'>
        <div className='w-full px-8 pt-6 pb-8 mb-4 bg-white  rounded'>
          ...
          <form
            ...
            className='mt-5 p-8 h-[650px] rounded border shadow-md border-t-4 border-t-blue-500 '
          >
            <input
              type='text'
            ...
            <button className=' ml-5 text-center py-3 rounded bg-blue-500 text-white hover:bg-blue-700 focus:outline-none my-1 w-1/5'>
